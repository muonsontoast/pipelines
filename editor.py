...
class Editor(Entity, QGraphicsView):
    def __init__(self, window, minScale = 3, maxScale = .2):
        ...
        self.AddBlock(kicker.Kicker, 'Welp', QPoint(1500, 1700))
        self.AddBlock(kicker.Kicker, 'Welp', QPoint(1500, 1800))
        ...
        self.AddBlock(bpm.BPM, 'BPM', QPoint(1350, 1400))
        self.AddBlock(bpm.BPM, 'BPM', QPoint(1350, 1500))
        self.AddBlock(bpm.BPM, 'BPM', QPoint(1350, 1600))
        self.AddBlock(bpm.BPM, 'BPM', QPoint(1350, 1700))
        self.AddBlock(bpm.BPM, 'BPM', QPoint(1350, 1800))
