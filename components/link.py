...
class LinkComponent(QWidget):
    def __init__(self, pv, component):
        ...
        self.type.layout().addItem(QSpacerItem(150, 0, QSizePolicy.Preferred, QSizePolicy.Preferred))
        # Element position
        ...
        self.position.layout().addItem(QSpacerItem(150, 0, QSizePolicy.Preferred, QSizePolicy.Preferred))
        # Element index
        self.index = QWidget()
        ...
        self.index.layout().addItem(QSpacerItem(150, 0, QSizePolicy.Preferred, QSizePolicy.Preferred))
