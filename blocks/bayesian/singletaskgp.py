...
class SingleTaskGP(Draggable):
    ...
    def SetupAndRunOptimiser(self, evaluateFunction):
        ...
        if self.settings['includeNominal']:
            ...
            print('These are my initial decisions:', self.initialDecisions)
            self.initialObjectives = np.array([o.Start() for o in self.objectives])
            print('These are my initial objectives:', self.initialObjectives)
        ...
        messageType = ''
        print('>>', [*self.initialDecisions, *self.initialObjectives, *self.initialConstraints])
